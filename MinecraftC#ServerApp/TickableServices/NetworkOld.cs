...
//{
//    public class NetworkOld : TickableService
//    {
...
//        public NetworkOld(string address, int port, Logger logger, Assembly packetAssembly, IEnumerable<string>? bannedIps = null)
//        {
...
//        public override string GetServiceName() => nameof(NetworkOld);
